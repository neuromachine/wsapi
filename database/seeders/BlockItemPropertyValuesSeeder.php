...
class BlockItemPropertyValuesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('block_item_property_values')->insert([
                ...
                ['id' => 103, 'item_id' => 500, 'property_id' => 22, 'value' => '45000'],
                ['id' => 104, 'item_id' => 500, 'property_id' => 23, 'value' => 'Интернет магазин крупнейшего в ЮФО поставщика шин и дисков для бизнеса'],
                ['id' => 105, 'item_id' => 500, 'property_id' => 24, 'value' => '<p>Интернет магазин крупнейшего в ЮФО поставщика шин и дисков для бизнеса</p>'],
                ['id' => 106, 'item_id' => 500, 'property_id' => 25, 'value' => 'thumb_tyres.png'],
                ['id' => 107, 'item_id' => 500, 'property_id' => 26, 'value' => 'tyres/desctop_main.png'],
                ['id' => 108, 'item_id' => 500, 'property_id' => 26, 'value' => 'tyres/desctop_catalog.png'],
                ['id' => 109, 'item_id' => 500, 'property_id' => 27, 'value' => json_encode([
                ...
                ['id' => 153, 'item_id' => 501, 'property_id' => 22, 'value' => '85000'],
                ['id' => 154, 'item_id' => 501, 'property_id' => 23, 'value' => 'Интернет магазин одежды для девушек'],
                ['id' => 155, 'item_id' => 501, 'property_id' => 24, 'value' => '<p>Интернет магазин ...</p>'],
                ['id' => 156, 'item_id' => 501, 'property_id' => 25, 'value' => 'thumb_raya.png'],
                ['id' => 157, 'item_id' => 501, 'property_id' => 26, 'value' => 'rayaray/desctop_main.png'],
                ['id' => 158, 'item_id' => 501, 'property_id' => 26, 'value' => 'rayaray/desctop_main_2.png'],
                ['id' => 159, 'item_id' => 501, 'property_id' => 27, 'value' => json_encode([
                    ['key'   => 'develop', 'label' => 'Разработка'],
                ])],
            ]
        );
